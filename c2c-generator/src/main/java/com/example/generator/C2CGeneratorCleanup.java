...
public class C2CGeneratorCleanup {
    public void cleanup() {
        try {
    ...
    public static void main(String[] args) {
        System.out.println("============C2CGeneratorCleanup================");
        C2CGeneratorCleanup c2cGeneratorCleanup = new C2CGeneratorCleanup();
        c2cGeneratorCleanup.cleanup();
    }
}
